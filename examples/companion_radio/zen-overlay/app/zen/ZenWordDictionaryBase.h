...
// Hand-curated, frequency-ranked conversational English derived from the
// ISC-licensed SUBTLEX-US spoken corpus, then localised with Australian
// spellings and everyday vocabulary. Fragments, proper names, profanity and
// explicit adult/violent terms are omitted for this child-friendly device.
// This list is the stable core: tools/generate_zen_dictionary.py appends
// EXTRA_WORDS after it without renumbering or regenerating these entries.
namespace zen_dictionary {
static const size_t BASE_WORD_COUNT = 2500;
static const char* const BASE_WORDS[BASE_WORD_COUNT] = {
