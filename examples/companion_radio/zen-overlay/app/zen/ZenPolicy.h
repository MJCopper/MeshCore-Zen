...
#include "../ZenPrefs.h"
#include "ZenFeatures.h"
#include <Utils.h>
#include <helpers/ContactInfo.h>
#include <helpers/AdvertDataHelpers.h>
#include <string.h>

// One fail-closed Zen policy boundary for every feature that can expose a child to
...
class Policy {
public:
  static bool childLocked(const ZenPrefs* prefs, bool parent_unlocked) {
  ...
  static bool channelsVisible(const ZenPrefs* prefs, bool locked) {
    return !locked || (prefs && prefs->child_channels_enabled);
  }

  static bool contactAllowed(const ZenPrefs* prefs, bool locked,
  ...
  static bool channelAllowed(const ZenPrefs* prefs, bool locked, uint8_t index,
